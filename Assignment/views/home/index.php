    ...
    <table class="table table-stripped">
        ...
        <?php foreach($cars as $pro):?>
            <tr>
                ...
                <td>
                    <a href="<?= BASE_URL . "cars/edit-car/$pro->id"?>" class="btn btn-sm btn-primary">Sửa</a> &nbsp;
                    <a href="<?= BASE_URL . "cars/remove/$pro->id"?>" class="btn btn-sm btn-danger btn-remove">Xóa</a>
                </td>
            </tr>
        <?php endforeach;?>
        </tbody>
