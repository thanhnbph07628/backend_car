<nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{BASE_URL .'admin'}}" class="nav-link">Bảng điều khiển</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{BASE_URL .'brands'}}" class="nav-link">Thương hiệu</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
            <a href="{{BASE_URL .'cars'}}" class="nav-link">Sản phẩm</a>
        </li>
    </ul>
