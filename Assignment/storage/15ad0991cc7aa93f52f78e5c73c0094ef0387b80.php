...
<div class="row">
    ...
    <form class="form-inline ml-3" method="get" action="<?php echo e(BASE_URL . 'brand/search'); ?>" enctype="multipart/form-data">
        ...
        <tbody>
        <?php $stt = 1; foreach($brand as $bra):?>
            <tr>
                <td><?php echo $stt; ?></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\Thanhnbph07628_php2\Assignment\views/brand/search.blade.php ENDPATH**/ ?>